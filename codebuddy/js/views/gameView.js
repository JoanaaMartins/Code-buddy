document.addEventListener("DOMContentLoaded", function () {
    ...
    function showRaking() {
      ...
      if (minutes < 10) {
        changeRegularContent(
          "Concluiste o jogo em menos de 10 minutos e recebeste uma medalha dourada",
          "/codebuddy/Escape_room/Assets/first_trophy.png"
        );
      } else if ((minutes) => 10 && minutes <= 20) {
        changeRegularContent(
          "Ganhaste uma medalha dourada pelo tempo que demoraste a concluir o jogo",
          "/codebuddy/Escape_room/Assets/second_trophy.png"
        );
      } else {
        changeRegularContent(
          "Concluiste o jogo e ganhaste uma medalha de bronze",
